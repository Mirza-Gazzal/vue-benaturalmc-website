<template>
    <section id="services-section" class="process-section" :style="'background-image: url('+backgroundImage+');'">
            ...
            <div class="row">
                ...
                <div class="process-block col-lg-6 col-md-6 col-sm-12" v-for="(service, key) in services">
                    <div class="inner-box">
                        ...
                        <img :alt='service.title' v-lazy="service.image" style="border-radius: 12px;height: 256px !important;width: 256px"></img>
                        <h4 class="mt-3 mb-2"><a style="color: #AC9837">{{service.title}}</a></h4>
...
<script>
    export  default {
        props :{
            ...
            backgroundImage: {
                default: '/images/background/8.jpg',
                required: false
            }
        }
    }
